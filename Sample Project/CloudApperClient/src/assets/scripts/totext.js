...
var ToText = /** @class */ (function() {
  ...
  ToText.prototype.toString = function() {
    ...
    //NOTE:AFTER ANGUALR 10 UPGRADE RRule.FREQUENCIES comes as null
    //Modified file path : node_modules/rrule/dist/esm/src/nlp/totext.js
    var RRuleFREQUENCIES = ['YEARLY', 'MONTHLY', 'WEEKLY', 'DAILY', 'HOURLY', 'MINUTELY', 'SECONDLY'];
    // @ts-ignore
    this[RRuleFREQUENCIES[this.options.freq]]();
    //NOTE:this code does not work after ANGUALR 10 UPGRADE
